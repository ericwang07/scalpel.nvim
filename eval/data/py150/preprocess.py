        ...
        try:
            ...
            for toknum, tokval, _, _, _ in token_gen:
                ...
                if toknum == STRING:
                    ...
                    toknum in [COMMENT, INDENT, ENCODING, ENDMARKER] or len(tokval) == 0
                ):
                    continue
                else:
...
def main():
    ...
    parser.add_argument(
        "--base_dir", default="py150_files", type=str, help="The downloaded data path"
    )
    parser.add_argument(
        "--output_dir",
        default="token_completion",
        type=str,
    ...
    train_paths = open(os.path.join(args.base_dir, "python100k_train.txt")).readlines()[
        :-5000
    ]
    dev_paths = open(os.path.join(args.base_dir, "python100k_train.txt")).readlines()[
        -5000:
    ]
